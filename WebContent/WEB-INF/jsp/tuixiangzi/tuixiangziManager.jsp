...
<script src="${ctx}/js/tuixiangzi/mapdata100.js"></script>
<script>
	...
	//预加载所有图片
	var oImgs = {
		"block" : "${ctx}/images/tuixiangzi/block.gif",
		"wall" : "${ctx}/images/tuixiangzi/wall.png",
		"box" : "${ctx}/images/tuixiangzi/box.png",
		"ball" : "${ctx}/images/tuixiangzi/ball.png",
		"up" : "${ctx}/images/tuixiangzi/up.png",
		"down" : "${ctx}/images/tuixiangzi/down.png",
		"left" : "${ctx}/images/tuixiangzi/left.png",
		"right" : "${ctx}/images/tuixiangzi/right.png",
	}
