...
<title>大鱼吃小鱼</title>
<link rel="shortcut icon" href="${ctx}/images/dayuchixiaoyu/fish.ico" type="image/x-icon">
...
<img src="${ctx}/images/dayuchixiaoyu/fish.png" width="50px" style="position:absolute;left:0;top:0;transition:transform 0.5s;margin:-25px 0 0 -25px;visibility:hidden" class="fish">
</div>
...
<img src="${ctx}/images/dayuchixiaoyu/bg.jpg" style="position:absolute;left:0;top:0;left:0;top:0;width:100%;height:100%">
...
if(Math.random()>0.5){
 $(".gamestt").append("<img src='${ctx}/images/dayuchixiaoyu/fish"+acbb+".png' class='abccaae"+dedeabc+"' style='position:absolute;left:100%;top:"+(10+(Math.random()*70))+"%' onmouseover='abcyu(this,"+acbb+")'>")
 $(".abccaae"+dedeabc).animate({left:"-126px"},(Math.random()*8000)+2000,"linear",function(){$(this).remove()})
}else{
 $(".gamestt").append("<img src='${ctx}/images/dayuchixiaoyu/fish"+acbb+".png' class='abccaae"+dedeabc+" rightsty' style='position:absolute;right:100%;top:"+(10+(Math.random()*70))+"%' onmouseover='abcyu(this,"+acbb+")'>")
